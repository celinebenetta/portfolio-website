    ...
    <>
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between ${
          isScroll
            ? "bg-white/50 backdrop-blur-lg shadow-sm shadow-white/20"
            : ""
        }`}
      >
        <a href="#top">
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 bg-darkHover text-white"
        >
